...
const PoolTable = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'price',
            render: (price) => (
                <p>{formatUSD(price, context.basenPrice)}</p>
            )
        },
        {
            title: 'Depth',
            ...
            key: 'depth',
            render: (depth) => (
                <p>{formatUSD(convertFromWei(depth), context.basenPrice)}</p>
            )
        },
        {
            title: 'Volume',
            ...
            key: 'volume',
            render: (volume) => (
                <p>{formatUSD(convertFromWei(volume), context.basenPrice)}</p>
            )
        },
        {
            title: 'TX Count',
        ...
        },
        {
            ...
            key: 'fees',
            render: (fees) => (
                <p>{formatUSD(convertFromWei(fees), context.basenPrice)}</p>
            )
        },
        {
            render: (record) => (
                ...
                <LabelGroup size={30} element={props.pool.symbol} label={props.pool.name} />
                    ...
                    <Row>
                        <Col xs={6}  xl={24} style={rowStylesPane}>
                            <LabelGroup size={20} element={formatUSD(convertFromWei(props.globalData?.totalStaked), context.basenPrice)} label={'Total Staked'} />
                        </Col>
                        <Col xs={6}  xl={24} style={rowStylesPane}>
                            <LabelGroup size={20} element={formatUSD(convertFromWei(props.globalData?.totalVolume), context.basenPrice)} label={'Total Volume'} />
                        </Col>
                        ...
                        <Col xs={6} xl={24} style={rowStylesPane}>
                            <LabelGroup size={20} element={formatUSD(convertFromWei(props.globalData?.totalFees), context.basenPrice)} label={'Total Fees'} />
                        </Col>
