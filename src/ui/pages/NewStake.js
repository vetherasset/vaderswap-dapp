...
import {
    ETH_ADDR, BASE_ADDR, ROUTER_ADDR, getRouterContract, getTokenContract, getListedTokens,
...
const NewStake = (props) => {
    ...
    const getData = async () => {
        ...
        checkApproval(BASE_ADDR) ? setApprovalS(true) : setApprovalS(false)
    ...
    const stake = async () => {
        ...
        await contract.methods.stake(stake1Data.input, stake2Data.input, pool.address).send({
            ...
            gasPrice: '',
            gas: '',
            value: pool.address === ETH_ADDR ? stake2Data.input : 0
        })
        ...
        <>
            ...
            <Row>
                <Col xs={8}>
                    ...
                    <PoolPaneSide pool={pool} price={context.basenPrice}  />
            ...
            <Row style={paneStyles}>
                <Col xs={24} style={colStyles}>
                    ...
                    <Row>
                        <Col xs={8}>
                            {!props.approval1 &&
                                <Center><Button type={'secondary'} onClick={props.unlockBase} icon={<UnlockOutlined />}>UNLOCK {props.stake1Data.symbol}</Button></Center>
                            }
                        </Col>
                        <Col xs={8}>
