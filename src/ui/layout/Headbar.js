...
// import logo from '../../assets/basen-logo-white.png';

import WalletDrawer from './WalletDrawer'
import { getAddressShort, } from '../../utils'
import { getTokenDetails, getListedTokens,
...
const Headbar = (props) => {
    ...
    const getBasePrice = async () => {
        // let resp = await axios.get('https://api.coingecko.com/api/v3/simple/price?ids=basen&vs_currencies=usd')
        // console.log(resp.data.basen.usd)
        // context.setContext({ 'basenPrice': resp.data.basen.usd })
        context.setContext({ 'basenPrice': 0.3 })
        return
    }
